        ...
        <div style={{ textAlign: 'center', paddingTop: '0.5rem' }}>
          ...
          <button
            ...
            style={{
              ...
              opacity: spotifyKeySaved ? 1 : 0.4,
              cursor: spotifyKeySaved ? 'pointer' : 'not-allowed',
            }}
          >
            ENTER APP →
          </button>
          {!spotifyKeySaved && (
            <p style={{ marginTop: '0.5rem', fontSize: '0.75rem', color: 'var(--text-dim)', fontStyle: 'italic' }}>
              Spotify key required to continue.
            </p>
          )}
        </div>
